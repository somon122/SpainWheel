...
public class PhoneAuthConfirmActivity extends AppCompatActivity {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                          ...
                          progressDialog.dismiss();
                            ...
                            Toast.makeText(PhoneAuthConfirmActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        }
                    }
                });
    ...
    private  PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Toast.makeText(PhoneAuthConfirmActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
